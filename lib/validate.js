...
function defaultOpts (opts) {
  ...
  const customWorker = opts.workers ? opts.customWorker : safeRequire(opts.customWorker)
  ...
  return {
    ...
    ...(customWorker ? { customWorker } : undefined),
...
module.exports = function validateOpts (opts, cbPassedIn) {
  ...
  if (!isValidFn(opts.customWorker)) {
    return new Error('Invalid option customWorker, please provide a class or constructor function (or file path to a module whose default export is one of these)')
  }
